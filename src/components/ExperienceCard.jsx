...
const ExperienceCard = ({ image, title, bio, isHighlight }) => {
  return (
    <div
      className={`flex flex-col transform transition-transform ease-linear hover:scale-105 mt-5 font-robot w-3/4 md:w-3/12 lg:w-3/12 2xl:w-1/6 items-center rounded-3xl ${
        isHighlight
